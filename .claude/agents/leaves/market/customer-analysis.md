...
- **required_deliverables**:
  - Persona 3~5개 (인구통계 + 행동 + 니즈)
  - JTBD 매칭
  - 세그먼트별 규모·WTP
  - 전환 요인 Top 3
- **company_profile_addons** (entity_type=company):
  - entity_type=company 시: 타겟 기업의 주요 고객 구성·비중
- **iteration_log 기록 의무**: `baseline_area: "고객 세그먼트·JTBD"` + `deliverable_status: {각 항목: complete|partial|unavailable}`
