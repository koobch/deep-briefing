...
- **required_deliverables**:
  - 핵심 인재 확보·유지·육성·보상 체계
  - 인재 파이프라인
  - 채용 시장 경쟁력
- **company_profile_addons** (entity_type=company):
  - entity_type=company 시: 최근 채용 공고 수·직무 분포
- **iteration_log 기록 의무**: `baseline_area: "인재 전략"` + `deliverable_status: {각 항목: complete|partial|unavailable}`
