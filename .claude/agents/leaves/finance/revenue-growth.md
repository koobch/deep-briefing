...
- **required_deliverables**:
  - 최근 3~5년 매출 추이 (YoY 성장률 포함)
  - 부문/세그먼트별 매출 구조 (상위 3~5개)
  - 주요 성장 동인 3개 + 감소 동인 (있으면)
  - 수익 모델 (구독/라이선스/광고/수수료 등 믹스)
- **company_profile_addons** (entity_type=company):
  - 분기별 추이 최소 4분기
  - 공시 기준 vs 관리 기준 차이 (해당 시)
- **iteration_log 기록 의무**: `baseline_area: "매출 구조·추이"` + `deliverable_status: {각 항목: complete|partial|unavailable}`
