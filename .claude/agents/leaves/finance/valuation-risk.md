...
- **required_deliverables**:
  - 기업 가치 평가 (DCF/Multiples)
  - 시나리오 P&L 3종
  - 민감도 분석 (핵심 가정 ±20%)
  - 주요 리스크 요인
- **company_profile_addons** (entity_type=company):
  - entity_type=company 시: 공정가치 추정 vs 시장가 비교
- **iteration_log 기록 의무**: `baseline_area: "밸류에이션·리스크"` + `deliverable_status: {각 항목: complete|partial|unavailable}`
