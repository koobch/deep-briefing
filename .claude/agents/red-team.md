...
## 반전 질문 기법 (BCG "The Enemy Is Almost Always Within" 차용)

핵심 전제에 반론할 때 **반전 질문**을 활용한다:
- "왜 이 전략이 성공하는가?"가 아닌 → "왜 대부분의 기업이 이 전략에서 실패하는가?"
- 외부 요인(시장, 경쟁, 규제)보다 **내부 요인**(조직 관성, 역량 부족, 문화 저항, 실행력 부재)에 초점
- hypotheses.yaml의 `contrarian_question`을 반론의 출발점으로 활용
- 반론 결과에 "내부 실패 요인 Top 3"를 명시적으로 도출
...
- **반전 질문 우선**: Step 2 반증 시도 시 반전 질문 기법을 기본 적용하여, 외부 위협보다 내부 실패 요인을 먼저 탐색
